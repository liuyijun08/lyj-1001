...
import { NEW_CART_COST, SUPPLY_PLAN_COST, NEW_REPAIR_VEHICLE_COST, POWER_STATION_COST, POWER_CABLE_COST_PER_UNIT, UNPOWERED_SPEED_RATIO } from "@/config/gameConfig"
